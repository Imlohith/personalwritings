      ...
      <section className="bg-gray-50 dark:bg-gray-800">
        <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-18 lg:px-6">
          <figure className="max-w-screen-md mx-auto">
            ...
            <blockquote>
              <p className="text-xl font-medium text-gray-900 md:text-2xl dark:text-white mb-4">
                "I am a full-stack developer with 3 years of experience in designing, building, and
                deploying web applications. I am well-versed in various programming languages,
              ...
              <p className="text-xl font-medium text-gray-900 md:text-2xl dark:text-white">
                ...
                services to build and deploy scalable, highly available, and fault-tolerant systems.
                I have experience working with services such as EC2, S3, Lambda, and RDS, and have a
                strong understanding of AWS best practices and architecture patterns."
              </p>
            </blockquote>
          </figure>
        </div>
